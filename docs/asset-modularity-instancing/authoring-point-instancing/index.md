...
In this lesson, you'll learn how to define PointInstancer {term}`prims <Prim>`, understand the differences between point and scenegraph instancing, and implement efficient large-scale scene representations. Here's what we'll accomplish:
...
* **Create** PointInstancer {term}`properties <Property>` including prototypes, positions, orientations, and indices
