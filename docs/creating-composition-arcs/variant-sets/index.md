...
Let's continue with the next lesson. In this lesson, *Variant Sets*, we’ll explore one of OpenUSD’s key features for creating flexible and adaptable {term}`assets <Asset>`. Here’s what we’re going to do:

- Examine the concept of variant sets in OpenUSD.
- Create and manipulate variant sets, using usdview and Python.
- Explore practical applications of variant sets in asset creation and {term}`scene composition <Composition>`.
